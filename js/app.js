(() => {
    ...
    (() => {
        ...
        let gotoblock_gotoBlock = (targetBlock, noHeader = false, speed = 500, offsetTop = 0) => {
            ...
            } else FLS(`[gotoBlock]: Yo... There is no such block on the page: ${targetBlock}`);
        };
            ...
            constructor(props, data = null) {
                ...
                if (this.config.init) {
                    ...
                    if (selectItems.length) {
                        ...
                        this.setLogging(`Woke up, built selects: (${selectItems.length})`);
                    } else this.setLogging("I'm sleeping, there is no select");
                }
            }
